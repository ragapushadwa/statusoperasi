...
?>
<?php
$ret=mysqli_query($con,"select *from tblpegawai where date(EnterDate) between '$fdate' and '$tdate'");
...
?>
                ...
                <td><?php  echo $row['outtime'];?></td>
                  <td><a href="visitor-pegawai-detail.php?editid=<?php echo $row['ID'];?>" title="View Full Details"><i class="fa fa-edit fa-1x"></i></a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
