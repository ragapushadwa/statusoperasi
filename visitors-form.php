...
$Keperluan=$_POST['Keperluan'];
 ...
 $query=mysqli_query($con,"insert into tblvisitor(FullName,Email,MobileNumber,Address,Keperluan) value('$fullname','$email','$mobnumber','$add', '$Keperluan')");
...
<body class="animsition">
    ...
    echo $msg;
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="Keperluan" name="Keperluan" placeholder="....." class="form-control" required="">
