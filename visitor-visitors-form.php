...
$Kategori=$_POST['kategori'];
 ...
 $query=mysqli_query($con,"insert into tblvisitor (FullName,Jenis,MobileNumber,Address,Keperluan) value('$fullname','$Kategori','$mobnumber','$add', '$Keperluan')");
...
<body class="animsition">
    ...
    echo $msg;
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Kategori Pengunjung</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                               
                                                <select name="kategori" class="form-control dropkategori" id="kategori" >
    ...
    <option value="Umum">Umum</option>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="mobilenumber" name="mobilenumber" placeholder="Mobile Number" class="form-control" maxlength="10" >
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="address" id="address" rows="9" placeholder="Enter Visitor Address..." class="form-control" ></textarea>
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="Keperluan" name="Keperluan" placeholder="....." class="form-control" >
...
<?php include_once('includes/footer.php');?>
    ...
    <script src="vendor/treeview/bootstrap-treeview.min.js">
    </script>
