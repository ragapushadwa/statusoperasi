            ...
            <div class="main-content">
			  ...
			  <th>Check Out</th>
                   ...
                   <th>Action</th>
                                       ...
                                       <?php
$ret=mysqli_query($con,"select *from tblvisitor where DATE(EnterDate)=CURDATE() && outtime IS NULL ");
$cnt=1;
...
?>
				...
				<td><?php  echo $row['outtime'];?></td>
				  ...
				  <form class="keluar" action="visitor-visitor-detail.php?editid=<?php echo $row['ID'];?>" method="post">
<input type="text" name="remark" value="Keluar" style="display:none;">
<input type="text" name="submit" value="" style="display:none;">
<input type="submit" value="Keluar" class="btn-danger btn-keluar" style="padding-left:5px;padding-right:5px;"  onclick="$(this).parents('tr').hide()"></input>
</form>
